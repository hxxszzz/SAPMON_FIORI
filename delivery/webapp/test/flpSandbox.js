		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapmonfioridelivery-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapmonfioridelivery-display": {
								"semanticObject": "sapmonfioridelivery",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapmon.fiori.delivery",
									"url": sap.ui.require.toUrl("sapmon/fiori/delivery")
								}
							}
						}
					}
